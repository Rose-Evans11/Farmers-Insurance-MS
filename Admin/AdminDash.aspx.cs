    ...
    public partial class Dashboard : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("SELECT firstName, middleName, lastName, position, emailAddress FROM tbl_admin WHERE emailAddress = @email_add", con);
        ...
        {
            Response.Redirect("AdminPendingReport?Parameter=" + lbl_session.Text);
        }
        //redirecting to pending page
        protected void link_process_Click(object sender, EventArgs e)
        {
            Response.Redirect("AdminInProcessReport?Parameter=" + lbl_session.Text);
        }
        //redirecting to pending page
        protected void link_close_Click(object sender, EventArgs e)
        {
            Response.Redirect("AdminCloseReport?Parameter=" + lbl_session.Text);
        }
