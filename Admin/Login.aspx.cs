...
namespace Farmers_Insurance_MS.Admin
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from tbl_admin where emailAddress=@emailAddress and password=@password", con);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                con.Open();
                SqlCommand cmd1 = new SqlCommand("SELECT firstName, lastName FROM tbl_admin WHERE emailAddress = @email", con);
                ...
                con.Close();
                Response.Redirect("~/Admin/AdminDash.aspx?Parameter=" + txt_user.Text);
            }
            else
            {
