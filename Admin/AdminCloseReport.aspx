<%@ Page Title="Close Report" Language="C#" MasterPageFile="~/AdminDashboard.Master" AutoEventWireup="true" CodeBehind="AdminCloseReport.aspx.cs" Inherits="Farmers_Insurance_MS.Admin.AdminCloseReport" %>
        ...
        <div class="col-lg-12">
            <asp:GridView ID="gv_report" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="reportID" DataSourceID="SqlDataSourceReport" Style="width: 100%" PageSize="5" Font-Size="Smaller" CellPadding="5" EmptyDataText="Null " HorizontalAlign="Center" Width="100%" OnSelectedIndexChanged="gv_report_SelectedIndexChanged" OnRowDataBound="gv_report_RowDataBound">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="datePlanted" HeaderText="datePlanted" SortExpression="datePlanted" />
                    <asp:BoundField DataField="dateApplied" HeaderText="dateApplied" SortExpression="dateApplied" />
                    <asp:BoundField DataField="dateStatus" HeaderText="dateStatus" SortExpression="dateStatus" />
            ...
            <asp:SqlDataSource ID="SqlDataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:db_fifmsConnectionString %>" SelectCommand="SELECT * FROM [tbl_report] WHERE ([remarks] = @remarks)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="Closed" Name="remarks" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
    </div>
        ...
        <center>
            <div class="col-lg-12">
                ...
                <table style="text-align: left">
                    ...
                    <tr>
                        <td>
                            <asp:TextBox ID="lbl_valid" runat="server" Text="" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td>
                            <itemtemplate>
                        ...
                        <td>
                            <asp:DropDownList ID="dl_status" runat="server" DataSourceID="SqlDataSourceStatus" DataTextField="remarks" DataValueField="remarks" ValidateRequestMode="Enabled" AppendDataBoundItems="True" Height="25px" Width="128px">
                                <asp:ListItem Selected="True" Value="" Text="Select Remarks"></asp:ListItem>
                            </asp:DropDownList>
