...
{
    public partial class AdminInProcessReport : System.Web.UI.Page
    {
    ...
    protected void gv_report_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            lbl_date.Text = row.Cells[20].Text.ToString();
            lbl_email.Text = row.Cells[21].Text;
            lbl_portion.Text = row.Cells[23].Text;
        ...
        protected void btn_update_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("UPDATE tbl_report SET [remarks] = @remarks, [dateStatus] = @dateStatus WHERE [reportID] = @reportID", con); // to add image [ProfileImg]=@ProfileImg 
            SqlDataAdapter adapter = new SqlDataAdapter();
            cmd.Parameters.AddWithValue("@reportID", lbl_report_id.Text);
            cmd.Parameters.AddWithValue("@dateStatus", lbl_date.Text);
