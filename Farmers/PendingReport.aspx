<%@ Page Title="Pending Report" Language="C#" MasterPageFile="~/UserDashboard.Master" AutoEventWireup="true" CodeBehind="PendingReport.aspx.cs" Inherits="Farmers_Insurance_MS.Farmers.PendingReport" %>
            ...
            <div class="col-lg-12">
                ...
                <table style="text-align: left">
                    ...
                    <tr>
                        <td>
                            <br />
                            <asp:Button ID="btn_change" runat="server" Text="Change Image" class="btn btn-warning" OnClick="btn_change_Click" /></td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            <asp:Button ID="btn_cancel" runat="server" Text="Cancel" class="btn btn-warning" Width="150px" />
                        </td>
